...
public class Client {
	...
	public Client(String ipNumber, int portNumber, int bufferSize, int objectsNumber) {
		...
		System.out.println("ID Cliente: " + this.idClient);
		System.out.println("IP Servidor: " + this.ipNumber);
		System.out.println("Puerto Servidor: " + this.portNumber);
	...
	public void start() {
		try {
			...
			for (int i = 0; i < objectsNumber; i++) {
				...
				object = new Object(i,
						LocalDateTime.now().atZone(ZoneId.of("GMT")).format(DateTimeFormatter.RFC_1123_DATE_TIME),
						objectsNumber);
